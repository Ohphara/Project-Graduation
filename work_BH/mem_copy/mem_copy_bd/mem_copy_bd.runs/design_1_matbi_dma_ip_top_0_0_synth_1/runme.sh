...
HD_PWD='C:/LAB/Project_Graduation/Project-Graduation/work_BH/mem_copy_bd/mem_copy_bd.runs/design_1_matbi_dma_ip_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_matbi_dma_ip_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_matbi_dma_ip_top_0_0.tcl
