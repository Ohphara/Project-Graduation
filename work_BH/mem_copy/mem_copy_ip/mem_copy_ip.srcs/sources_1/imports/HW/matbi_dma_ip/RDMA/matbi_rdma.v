...
// Create Date:
// Design Name: matbi_rdma
// Module Name: matbi_rdma
// Project Name:
// Target Devices: Zybo Z7-20
// Tool Versions:
// Description: rdma hand rtl!!
// Dependencies:
//
// Revision:
...
reg [1:0] 	c_state_ar; // Current state  (F/F)
reg [1:0] 	n_state_ar; // Next state (Variable in Combinational Logic)

reg [1:0] 	c_state_r; // Current state  (F/F)
reg [1:0] 	n_state_r; // Next state (Variable in Combinational Logic)
...
reg  [31:0] r_rdma_baseaddr; // base address
...
assign m_axi_gmem_ARSIZE   = 3'b011; // Burst Size : 8 Bytes. 2^3
...
always @(posedge ap_clk) begin
	if(ap_rst) begin
		...
		r_rdma_baseaddr				<= mem; // base address
    end
end
/////////////////////////////////////////// 1. main ctrl 
...
///////////////////////////////////////////// 3. Ctrl of AXI4 READ #2 channels
////////////////////////// AR
// ARADDR Cal

wire [31-NUM_SAMPLE_IN_AXI_DATA:0] remain_hs = r_num_total_stream_hs - r_hs_data_cnt;
...
assign rdma_offset_addr = {r_hs_data_cnt, {AXI_DATA_SHIFT{1'b0}}};
