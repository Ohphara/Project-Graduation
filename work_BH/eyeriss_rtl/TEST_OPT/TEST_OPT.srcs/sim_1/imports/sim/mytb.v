...
//    west 0 glb interfaces             //
	...
	reg [ADDR_BITWIDTH_GLB-1:0] w_addr_iact_west_0;
	
	reg signed [DATA_BITWIDTH-1:0] w_data_wght_west_0;
	reg [ADDR_BITWIDTH_GLB-1:0] w_addr_wght_west_0;
	reg write_en_wght_west_0;

	reg [ADDR_BITWIDTH_GLB-1:0] r_addr_psum_west_0;
	wire signed [DATA_BITWIDTH-1:0] r_data_psum_west_0;
	reg r_req_psum_west_0;

	reg [ADDR_BITWIDTH_GLB-1:0] r_addr_psum_inter_west_0;
...
//    west 1 glb interfaces            //
	...
	reg [ADDR_BITWIDTH_GLB-1:0] w_addr_iact_west_1;
	
	reg signed [DATA_BITWIDTH-1:0] w_data_wght_west_1;
	reg [ADDR_BITWIDTH_GLB-1:0] w_addr_wght_west_1;
	reg write_en_wght_west_1;

	reg [ADDR_BITWIDTH_GLB-1:0] r_addr_psum_west_1;
	wire signed [DATA_BITWIDTH-1:0] r_data_psum_west_1;
	reg r_req_psum_west_1;

	reg [ADDR_BITWIDTH_GLB-1:0] r_addr_psum_inter_west_1;
...
//   east 0   glb interfaces          //
	...
	reg [ADDR_BITWIDTH_GLB-1:0] w_addr_iact_east_0;
	
	reg signed [DATA_BITWIDTH-1:0] w_data_wght_east_0;
	reg [ADDR_BITWIDTH_GLB-1:0] w_addr_wght_east_0;
	reg write_en_wght_east_0;

	reg [ADDR_BITWIDTH_GLB-1:0] r_addr_psum_east_0;
	wire signed [DATA_BITWIDTH-1:0] r_data_psum_east_0;
	reg r_req_psum_east_0;

	reg [ADDR_BITWIDTH_GLB-1:0] r_addr_psum_inter_east_0;
...
//   east 1 glb interfaces           //
	...
	reg [ADDR_BITWIDTH_GLB-1:0] w_addr_iact_east_1;
	
	reg signed [DATA_BITWIDTH-1:0] w_data_wght_east_1;
	reg [ADDR_BITWIDTH_GLB-1:0] w_addr_wght_east_1;
	reg write_en_wght_east_1;

	reg [ADDR_BITWIDTH_GLB-1:0] r_addr_psum_east_1;
	wire signed [DATA_BITWIDTH-1:0] r_data_psum_east_1;
	reg r_req_psum_east_1;

	reg [ADDR_BITWIDTH_GLB-1:0] r_addr_psum_inter_east_1;
