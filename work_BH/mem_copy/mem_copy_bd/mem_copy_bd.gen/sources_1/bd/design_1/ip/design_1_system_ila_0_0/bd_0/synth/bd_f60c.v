...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_1_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_1_AXI, ADDR_WIDTH 12, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, DATA_WIDTH 32, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 0, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 8, NUM_READ_THREADS 4, NUM_WRITE_OUTSTANDING 8, NUM_WRITE_THREADS 4, PHASE 0.0, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [11:0]SLOT_1_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe21(net_slot_0_axi_awregion),
        .probe22(net_slot_0_axi_awsize),
        .probe23(net_slot_0_axi_awuser),
        .probe24(net_slot_0_axi_b_cnt),
        .probe25(net_slot_0_axi_bid),
        .probe26(net_slot_0_axi_bresp),
        .probe27(net_slot_0_axi_buser),
        ...
        .probe32(net_slot_0_axi_ruser),
        .probe33(net_slot_0_axi_wdata),
        .probe34(net_slot_0_axi_wstrb),
        .probe35(net_slot_0_axi_wuser),
        ...
        .probe46(net_slot_1_axi_bresp),
        .probe47(net_slot_1_axi_r_cnt),
        .probe48(net_slot_1_axi_rdata),
        .probe49(net_slot_1_axi_rresp),
        .probe5(net_slot_0_axi_arlen),
        .probe50(net_slot_1_axi_wdata),
        .probe51(net_slot_1_axi_wstrb),
        .probe52(net_slot_1_axi_aw_ctrl),
        .probe53(net_slot_1_axi_w_ctrl),
        .probe54(net_slot_1_axi_b_ctrl),
        .probe55(net_slot_1_axi_ar_ctrl),
        .probe56(net_slot_1_axi_r_ctrl),
