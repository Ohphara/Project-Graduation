...
HD_PWD='C:/Project_Graduation/Project-Graduation/work_BH/eyeriss_rtl/TEST_OPT/TEST_OPT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HMNOC_4cluster_wpsum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HMNOC_4cluster_wpsum.tcl
