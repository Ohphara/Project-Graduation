...
HD_PWD='C:/LAB/Project-Graduation/Project-Graduation/work_BH/eyeriss_core/eyeriss_core.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPad_DP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPad_DP.tcl
